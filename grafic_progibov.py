...
g = ["Локомотив Кривая Лето", "Локомотив Прямая Зима", "Локомотив Прямая Лето", "Локомотив Кривая Зима", "Вагон Кривая Лето", "Вагон Прямая Зима", "Вагон Прямая Лето", "Вагон Кривая Зима"]
k = main.k * 2
